...
import { BookOpen, FileText, Sparkles, ChevronRight, Circle, CheckCircle2, CircleDashed, Clock } from 'lucide-react';
...
const SyllabusTab = ({ course, role, studentId }: TabContext) => {
  ...
  return (
    <div className="space-y-4">
            ...
            {sessions.map((s) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    'flex-shrink-0 px-3 py-2 rounded-lg border text-xs font-medium transition',
      ...
      <h3 className="font-display text-lg font-bold">In-Class & Homework</h3>
